...
router.route("/Question").post(dataController.create);

router.route("/dashboard/:name").get(dataController.populateDashboard);
...
router.route("/like/:answerID").post(dataController.addLike);
